        ...
        <div class="container nav">
            <a href="#home" class="brand">
                @if($generalSetting?->logo)
                    <img src="{{ $generalSetting->logo }}" alt="{{ $generalSetting->site_name }}" class="brand-logo">
                @else
            ...
            <div class="nav-cta">
                <a href="#contact" class="btn btn-primary desktop-only">Start a Conversation</a>
    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-left">
                <div class="footer-brand">
                    @if($generalSetting?->logo)
                        <img src="{{ $generalSetting->logo }}" alt="{{ $generalSetting->site_name }}" class="footer-brand-logo">
                    @else
        ...
        <div class="footer-bottom">
            <div class="footer-bottom-left">
                <div class="footer-social">
                    @if($generalSetting?->facebook)
                        <a href="{{ $generalSetting->facebook }}" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                    ...
                    @if($generalSetting?->linkedin)
                        <a href="{{ $generalSetting->linkedin }}" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    ...
                    @if($generalSetting?->instagram)
                        <a href="{{ $generalSetting->instagram }}" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    @if($generalSetting?->youtube)
                        <a href="{{ $generalSetting->youtube }}" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            ...
            <div class="footer-bottom-center">
                <a href="#home" class="footer-top-link" aria-label="Back to top">
                    <span>Top</span>
